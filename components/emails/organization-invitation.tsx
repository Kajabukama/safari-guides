          ...
          <Container className="bg-white rounded-[8px] shadow-sm max-w-[600px] mx-auto p-[40px]">
            ...
            <Section className="mb-[32px]">
              ...
              <Text className="text-[16px] text-gray-700 mb-[16px] m-0">
                <strong>{props.invitedByUsername}</strong> ({props.invitedByEmail}) has invited you
                to join <strong>{props.teamName}</strong> on our platform.
              </Text>
              <Text className="text-[16px] text-gray-700 mb-[24px] m-0">
                Accept this invitation to start collaborating with your team members and access all
                the tools and resources available in your organization.
              </Text>
            </Section>
            ...
            <Section className="mb-[32px]">
              <Text className="text-[14px] text-gray-600 mb-[8px] m-0">
                If the button above doesn&apos;t work, you can also copy and paste this link into
                your browser:
              </Text>
            ...
            <Section className="border-t border-gray-200 pt-[24px]">
              <Text className="text-[12px] text-gray-500 text-center m-0 mb-[8px]">
                This invitation was sent to {props.email}. If you weren&apos;t expecting this
